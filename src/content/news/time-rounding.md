...
newsCategory: "guide"
excerptHtml: "<p>18:23の退社を18:20とみなすような丸め処理（端数処理）の考え方と、ペンギンタイムカードでの丸め単位・切り捨て／切り上げの設定について説明します。</p>"
description: "18:23の退社を18:20とみなすような丸め処理（端数処理）の考え方と、ペンギンタイムカードでの丸め単位・切り捨て／切り上げの設定について説明します。"
