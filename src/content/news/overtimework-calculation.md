...
newsCategory: "guide"
excerptHtml: "<p>残業時間の計算が必要になるのは主に正社員、総勤務時間の計算が必要になるのは主にパート従業員です。ペンギンタイムカードでのそれぞれの集計の考え方を説明します。</p>"
description: "残業時間の計算が必要になるのは主に正社員、総勤務時間の計算が必要になるのは主にパート従業員です。ペンギンタイムカードでのそれぞれの集計の考え方を説明します。"
